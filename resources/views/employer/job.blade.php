          ...
          @forelse($job as $j)
              <div class="well" id="{!!isset($j->id)?$j->id:NULL!!}">
                ...
                <div class="row">
                  ...
                  {{-- show job --}}
                    <div class="">
                        <div class="row show_job_details">
                        ...
                        <div class="row">
                            ...
                            <span data-toggle="tooltip" title="created_at" class="text-primary"></span><span class="badge">{{isset($applied)?$applied:NULL}}</span>

                            <span data-toggle="tooltip" title="created_at" class="text-primary"></span><a href="{{url('employer/applicantlist/'.$j->id)}}"><span class="badge">{{isset($applied2[$j->id])?$applied2[$j->id]:null}}</span></a>
...
<div id="hide_form_part_1">
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            {{ Form::select('industrytype_id',isset($industry) ? $industry:["0"=>"0"],null,['placeholder' => 'Select Industrytype','class'=>'form-control','id'=>'industrytype_id'])}}
        </div>
...
<div id="editjob" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div id="hide_edit_form_part_1">
      <div class="form-group">
            {{ Form::label('jobtitle','Job Title', ['class' => 'control-label']) }}
            {{ Form::text('jobtitle',null,array('class' => 'form-control jobtitle')) }}
        ...
        {{--get user id--}}{{--add job id--}}
            ...
            {{ Form::label('catagory_id', 'Category', ['class' => 'control-label']) }}
            {{ Form::select('catagory_id',isset($cat) ? $cat:["0"=>"0"],null,['placeholder' => 'Select Category','class'=>'form-control catagory_id'])}}
        </div>
        <div class="form-group">
            {{ Form::label('CompanyIndustryType ', 'Company Industry Type ', ['class' => 'control-label']) }}
            {{ Form::select('industrytype_id',isset($industry) ? $industry:["0"=>"0"],null,['placeholder' => 'Select Industrytype','class'=>'form-control industrytype_id'])}}
        </div>
        ...
        <div class="">
           ...
           <h3 class="text-success job_title"></h3>
             ...
             <tr>
                <td>Age Limit</td>
               <td>:</td>
               <td class="age_limit"></td>
             </tr> 
             <tr>
                <td>Job Type</td>
               <td>:</td>
               <td class="job_type"></td>
             </tr>
              <tr>
                <td>Job Level</td>
               <td>:</td>
               <td class="job_level"></td>
             </tr>
             <tr>
                <td>Educational Qualification</td>
               <td>:</td>
               <td class="educational_qualification"></td>
             </tr>
             <tr>
                <td>Job Responsibilities</td>
               <td>:</td>
               <td class="job_responsibilities"></td>
             </tr>
             <tr>
                <td>Exprience</td>
               <td>:</td>
               <td class="job_experiences_year"></td>
             </tr>
             <tr>
                <td>Exprience Field</td>
               <td>:</td>
               <td class="job_experiences_field"></td>
             </tr>  
