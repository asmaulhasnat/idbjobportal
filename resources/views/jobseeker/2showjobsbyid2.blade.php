...
<tr>
  ...
  <td>{!! $apply=="true" ? "<span class='bg-warning text-danger pull-right'>you already applied</span>" : "<a href='{{url(jobseeker/apply/'.$j->id) class='btn btn-success pull-right'>apply</a>"!!}</td>
</tr>
