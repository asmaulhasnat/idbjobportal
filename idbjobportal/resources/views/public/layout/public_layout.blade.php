...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="IdbJobportal">
        <meta name="author" content="">
        <meta name="keyword" content="Bangladeshi job side">
                    ...
                    <!-- HEADER CONTACT INFO -->
                        <div class="header-half header-call">
                            <p>
                                ...
                                <span><i class="icon-mail"></i>{{ isset($portal_option['site_email'])?$portal_option['site_email']:"idbjobportal@gmail.com" }}</span>
                            </p>
                        </div>
                    </div>
