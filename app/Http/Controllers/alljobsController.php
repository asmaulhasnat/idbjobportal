...
##########Show All Jobs#########
   ...
   public function showalljobs(){
   	...
   	$jobseeker_id=Auth::guard('jobseeker')->user()->id;
	  		...
	  		$job=job::where('published',1)->whereNotIn('employer_id',$blockcheck)->orderByRaw('employer_id in('.$fl.') desc, id desc')->paginate(10);
	  		...
	  		$job=job::where('published',1)->whereNotIn('employer_id',$blockcheck)->orderBy('id','desc')->paginate(10);
	  		...
	  		$job=job::where('published',1)->orderByRaw('employer_id in ('.$fl.')desc, id desc')->paginate(10);
...
public function show($id){
	$catagories=catagory::all();
		$jobseeker_id=Auth::guard('jobseeker')->user()->id;
	         ...
	         $catjobs=job::where('catagory_id',$id)->where('published',1)->whereNotIn('employer_id',$blockcheck)->paginate(10);
	...
	$catjobs=job::where('catagory_id',$id)->where('published',1)->paginate(10);
	return view('jobseeker.showjobsbycat',compact('catjobs','catagories'));
	}
}
